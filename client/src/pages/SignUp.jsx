...
const SignUp = () => {
  return (
    <section className="bg-gray-950  text-white">
      <div className="w-[90%] max-w-5xl mx-auto  min-h-[93vh]  pt-24 ">
        <h2 className="pb-8 text-3xl font-medium text-center">Sign up</h2>
        ...
        <div className="bg-gray-800 max-w-sm mx-auto px-5 pb-10 rounded-b-lg flex items-center gap-2">
          ...
          <Link to="/sign-in" className="text-[0.875rem] text-blue-300">
            Sign in
          </Link>
        </div>
      </div>
